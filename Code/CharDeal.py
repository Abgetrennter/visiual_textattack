...
def _char_mars(_char: HanZi, func: int = 2) -> HanZi:
    ...
    match func:
        case 1:
            return choice(adds)
        case 2:
            return sorted(adds, key=lambda c: abs((c.count - _char.count) / _char.count))[0]
        case 0 | _:
            return adds[0]
...
if __name__ == '__main__':
    ...
    s="".join(char_flatten(Hanzi_dict[c]) for c in sentence_example[:20])+sentence_example[20:]
    print(s)
